...
list(
  ...
  tar_target(
    model_2grp,
    compile_model("stan/betairt_2grp.stan"),
    deployment = "main"
  ),
  ...
  tar_target(
    adapt_test_time_rev, # adaptive test of study 2 participants, using study 1 estimates
    adapt12(data2$dat, data, postmns, median_times, use_times = TRUE)
  ),
  tar_target(
    data3,
